<div>
    <h2 class="text-center rounded  bg-indigo-600 font-bold text-white border-y-2 p-2 m-4">Cuotas fijas con o sin anticipo</h2>
    
    @if ($formulario)
        <form class="container p-2 mt-1 border rounded" wire:submit.prevent='calcularCuotasConAnticipo'>
            <!--Anticipo -->
            <div class="">
