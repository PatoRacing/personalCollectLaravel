<div >
    <h2 class="text-center rounded  bg-indigo-600 font-bold text-white border-y-2 p-2 m-4">Cancelación </h2>

    @if ($formulario)
        <form class="container p-2 mt-1 border rounded" wire:submit.prevent='calcularQuita'>
    ...
    @if ($resultados)
        <div class="border rounded p-2">
            <div class="p-2 ">
                ...
                <p>Monto a Pagar: ${{number_format($monto_a_pagar, 2, ',', '.') }}</p>
            </div>
